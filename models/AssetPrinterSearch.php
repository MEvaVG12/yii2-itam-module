...
/**
 * AssetPrinterSearch represents the model behind the search form about `marqu3s\itam\models\AssetPrinter`.
 */
class AssetPrinterSearch extends AssetPrinter
{
    /**
     * @inheritdoc
     */
