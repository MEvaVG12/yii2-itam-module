...
/**
 * AssetSwitchSearch represents the model behind the search form about `marqu3s\itam\models\AssetSwitch`.
 */
class AssetSwitchSearch extends AssetSwitch
{
    /**
     * @inheritdoc
     */
