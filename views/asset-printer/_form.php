...
<div class="printer-form">
    ...
    <!--<div class="row">
        <div class="col-sm-4">
            <?/*= $form->field($model->assetAccessPoint, 'firmware_version')->textInput(['maxlength' => true]) */?>
        </div>
        <div class="col-sm-4">
            <?/*= $form->field($model->assetAccessPoint, 'firmware_release_date')->textInput(['maxlength' => true]) */?>
        </div>
        <div class="col-sm-4">
            <?/*= $form->field($model->assetAccessPoint, 'firmware_install_date')->textInput(['maxlength' => true]) */?>
        </div>
    </div>-->
